/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f69f7022036a8c7790e1c13b2f540c92)
// Runtime types generated with workerd@1.20251202.0 2024-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GameRoom" | "GlobalLobby";
	}
	interface Env {
		ENVIRONMENT: "development" | "staging" | "production";
		GAME_ROOM: DurableObjectNamespace<import("./src/worker").GameRoom>;
		GLOBAL_LOBBY: DurableObjectNamespace<import("./src/worker").GlobalLobby>;
	}
}
