...
<CardGroup cols={2} rows={2}>
  <Card title={<div className="flex items-start gap-2"><div>Eleven v3</div><div><img src="file:70a315a4-6ff7-442b-8925-98632d3116fc" alt="Alpha" /></div></div>} href="/docs/overview/models#eleven-v3-alpha">
    ...
    <div className="mt-4 space-y-2">
      ...
      <div className="text-sm">5,000 character limit</div>
...
<CardGroup cols={2} rows={1}>
  <Card title="Scribe v1" href="/docs/overview/models#scribe-v1">
...
| `scribe_v2_realtime`         | Real-time speech recognition model                                                      | [99 languages](/docs/overview/capabilities/speech-to-text#supported-languages)                                                                                                                  |
| `scribe_v1`                  | State-of-the-art speech recognition. Outclassed by v2 models                            | [99 languages](/docs/overview/capabilities/speech-to-text#supported-languages)                                                                                                                  |
...
Eleven Flash v2.5 is our fastest speech synthesis model, designed for real-time applications and Agents Platform. It delivers high-quality speech with ultra-low latency (~75ms&dagger;) across 32 languages.
...
Read more about Scribe v1 [here](/docs/overview/capabilities/speech-to-text).
...
Read more about Scribe v2 Realtime [here](/developers/guides/cookbooks/speech-to-text/streaming).
...
<Note>Startup grants recipients receive Scale level benefits.</Note>
...
<Frame background="subtle">
  <img
    src="file:2a67186c-ac8a-4e1f-89b5-5236ab18b34b"
